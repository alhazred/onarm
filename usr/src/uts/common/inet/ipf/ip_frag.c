...
#pragma ident	"@(#)ip_frag.c	1.6	07/05/15 SMI"
...
nat_t *nat;
{
	...
	if ((fin->fin_v != 4) || (ifs->ifs_fr_frag_lock != 0))
		return 0;
...
fr_info_t *fin;
{
	...
	if ((fin->fin_v != 4) || (ifs->ifs_fr_frag_lock) || !ifs->ifs_ipfr_natlist)
		return NULL;
...
fr_info_t *fin;
{
	...
	if ((fin->fin_v != 4) || (ifs->ifs_fr_frag_lock) || !ifs->ifs_ipfr_ipidlist)
		return 0xffffffff;
