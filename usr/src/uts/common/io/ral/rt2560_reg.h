...
#pragma ident	"@(#)rt2560_reg.h	1.1	07/07/03 SMI"

#ifdef __cplusplus
extern "C" {
#endif

#define	RT2560_TX_RING_COUNT		250	/* 48 */
#define	RT2560_ATIM_RING_COUNT		4
#define	RT2560_PRIO_RING_COUNT		32	/* 16 */
#define	RT2560_BEACON_RING_COUNT	1
#define	RT2560_RX_RING_COUNT		250	/* 32 */
...
#define	RT2560_RF_BUSY			((uint32_t)1 << 31)
...
#define	RT2560_EEPROM_CTL(sc, val) do {					\
	...
	drv_usecwait(RT2560_EEPROM_DELAY);				\
	_NOTE(CONSTCOND)						\
} while (/* CONSTCOND */0)
