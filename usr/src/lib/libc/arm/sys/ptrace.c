...
again:
	...
	case 9:		/* PTRACE_SINGLESTEP */
		...
		if (cp->flags & CS_SETREGS) {
			...
			ps->pr_lwp.pr_reg[REG_R0]   = cp->user.u_reg[REG_R0];
			ps->pr_lwp.pr_reg[REG_R1]   = cp->user.u_reg[REG_R1];
			ps->pr_lwp.pr_reg[REG_R2]   = cp->user.u_reg[REG_R2];
			ps->pr_lwp.pr_reg[REG_R3]   = cp->user.u_reg[REG_R3];
			ps->pr_lwp.pr_reg[REG_R4]   = cp->user.u_reg[REG_R4];
			ps->pr_lwp.pr_reg[REG_R5]   = cp->user.u_reg[REG_R5];
			ps->pr_lwp.pr_reg[REG_R6]   = cp->user.u_reg[REG_R6];
			ps->pr_lwp.pr_reg[REG_R7]   = cp->user.u_reg[REG_R7];
			ps->pr_lwp.pr_reg[REG_R8]   = cp->user.u_reg[REG_R8];
			ps->pr_lwp.pr_reg[REG_R9]   = cp->user.u_reg[REG_R9];
			ps->pr_lwp.pr_reg[REG_R10]  = cp->user.u_reg[REG_R10];
			ps->pr_lwp.pr_reg[REG_R11]  = cp->user.u_reg[REG_R11];
			ps->pr_lwp.pr_reg[REG_R12]  = cp->user.u_reg[REG_R12];
			ps->pr_lwp.pr_reg[REG_SP]   = cp->user.u_reg[REG_SP];
			ps->pr_lwp.pr_reg[REG_LR]   = cp->user.u_reg[REG_LR];
			ps->pr_lwp.pr_reg[REG_PC]   = cp->user.u_reg[REG_PC];
			ps->pr_lwp.pr_reg[REG_CPSR] = cp->user.u_reg[REG_CPSR];
...
MakeUser(cstatus_t *cp)
{
	...
	cp->user.u_reg[REG_R0]   = ps->pr_lwp.pr_reg[REG_R0];
	cp->user.u_reg[REG_R1]   = ps->pr_lwp.pr_reg[REG_R1];
	cp->user.u_reg[REG_R2]   = ps->pr_lwp.pr_reg[REG_R2];
	cp->user.u_reg[REG_R3]   = ps->pr_lwp.pr_reg[REG_R3];
	cp->user.u_reg[REG_R4]   = ps->pr_lwp.pr_reg[REG_R4];
	cp->user.u_reg[REG_R5]   = ps->pr_lwp.pr_reg[REG_R5];
	cp->user.u_reg[REG_R6]   = ps->pr_lwp.pr_reg[REG_R6];
	cp->user.u_reg[REG_R7]   = ps->pr_lwp.pr_reg[REG_R7];
	cp->user.u_reg[REG_R8]   = ps->pr_lwp.pr_reg[REG_R8];
	cp->user.u_reg[REG_R9]   = ps->pr_lwp.pr_reg[REG_R9];
	cp->user.u_reg[REG_R10]  = ps->pr_lwp.pr_reg[REG_R10];
	cp->user.u_reg[REG_R11]  = ps->pr_lwp.pr_reg[REG_R11];
	cp->user.u_reg[REG_R12]  = ps->pr_lwp.pr_reg[REG_R12];
	cp->user.u_reg[REG_SP]   = ps->pr_lwp.pr_reg[REG_SP];
	cp->user.u_reg[REG_LR]   = ps->pr_lwp.pr_reg[REG_LR];
	cp->user.u_reg[REG_PC]   = ps->pr_lwp.pr_reg[REG_PC];
	cp->user.u_reg[REG_CPSR] = ps->pr_lwp.pr_reg[REG_CPSR];
